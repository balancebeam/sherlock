...
import io.pddl.ExtSqlMapClientTemplate;
import io.pddl.datasource.PartitionDataSource;
import io.pddl.executor.exec.DMLExec;
import io.pddl.executor.exec.DQLExec;
import io.pddl.router.table.LogicTableRouter;

/**
 * {@link ExtSqlExecutor} is an extension to ibatis's default
 ...
 * {@link ExtSqlExecutor} for situations when you have to partition
 ...
 * you still need them.<br> {@link ExtSqlExecutor} usually can monitor and statistic
...
public class ExtSqlExecutor extends SqlExecutor {
	...
	final Log logger= LogFactory.getLog(ExtSqlExecutor.class);
	...
	private ExtSqlMapClientTemplate template;
	...
	public void setCobarSqlMapClientTemplate(ExtSqlMapClientTemplate template){
