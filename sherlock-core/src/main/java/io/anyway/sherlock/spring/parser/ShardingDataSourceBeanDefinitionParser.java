...
import static io.anyway.sherlock.spring.Constants.DATABASE_ROUTER;
import static io.anyway.sherlock.spring.Constants.DATA_BASE_STRATEGY;
import static io.anyway.sherlock.spring.Constants.DATA_BASE_TYPE;
import static io.anyway.sherlock.spring.Constants.DATA_SOURCE_NAME;
import static io.anyway.sherlock.spring.Constants.DATA_SOURCE_PARTITION;
import static io.anyway.sherlock.spring.Constants.DATA_SOURCE_PARTITIONS;
import static io.anyway.sherlock.spring.Constants.DATA_SOURCE_REF;
import static io.anyway.sherlock.spring.Constants.DATA_SOURCE_WEIGHT;
import static io.anyway.sherlock.spring.Constants.FOREIGN_KEY;
import static io.anyway.sherlock.spring.Constants.GLOBAL_TABLE;
import static io.anyway.sherlock.spring.Constants.LOGIC_CHILD_TABLE;
import static io.anyway.sherlock.spring.Constants.LOGIC_TABLE;
import static io.anyway.sherlock.spring.Constants.MASTER_DATA_SOURCE;
import static io.anyway.sherlock.spring.Constants.POOL_SIZE;
import static io.anyway.sherlock.spring.Constants.PRIMARY_KEY;
import static io.anyway.sherlock.spring.Constants.READ_STRATEGY;
import static io.anyway.sherlock.spring.Constants.SHARDING_CACHE;
import static io.anyway.sherlock.spring.Constants.SLAVE_DATA_SOURCE;
import static io.anyway.sherlock.spring.Constants.TABLES;
import static io.anyway.sherlock.spring.Constants.TABLE_NAME;
import static io.anyway.sherlock.spring.Constants.TABLE_POSTFIXES;
import static io.anyway.sherlock.spring.Constants.TABLE_STRATEGY;
import static io.anyway.sherlock.spring.Constants.TIME_OUT;
import static io.anyway.sherlock.spring.Constants.PARTITION_DATA_SOURCE_NAMES;

import java.util.*;

import io.anyway.sherlock.datasource.DatabaseType;
import io.anyway.sherlock.datasource.support.PartitionDataSourceSupport;
import io.anyway.sherlock.datasource.support.ShardingDataSourceRepositorySupport;
import io.anyway.sherlock.datasource.support.WeightDataSourceProxy;
import io.anyway.sherlock.jdbc.ShardingDataSource;
import io.anyway.sherlock.router.database.support.DatabaseRouterSupport;
import io.anyway.sherlock.router.table.config.LogicChildTableConfig;
import io.anyway.sherlock.router.table.config.LogicTableConfig;
import io.anyway.sherlock.router.table.support.GlobalTableRepositorySupport;
import io.anyway.sherlock.router.table.support.LogicTableRepositorySupport;
import io.anyway.sherlock.router.table.support.LogicTableRouterSupport;
...
import io.anyway.sherlock.executor.support.ExecuteProcessorSupport;
import io.anyway.sherlock.router.support.SQLRouterSupport;
